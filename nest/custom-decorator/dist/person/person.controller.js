...
const allDecorator_1 = require("../allDecorator");
const person_custom_decorator_1 = require("../person-custom-decorator");
const header_custom_decorator_1 = require("../header-custom-decorator");
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, allDecorator_1.AllDecorator)('yuan', 30),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, person_custom_decorator_1.customDecorator)(new common_1.ParseIntPipe())),
    __param(2, (0, header_custom_decorator_1.headerDecorator)('user-agent')),
    __metadata("design:type", Function),
